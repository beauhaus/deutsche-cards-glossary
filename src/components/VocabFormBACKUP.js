...
class VocabForm extends Component {
    constructor(props) {
        super(props)
        console.log("P.VItem: ", props.vocabItem)
        this.state =
            {
                word_de: props.vocabItem.word_de ? props.vocabItem.word_de : '',
                word_en: props.vocabItem.word_de ? props.vocabItem.word_en : '',
                example_de: props.vocabItem.word_de ? props.vocabItem.example_de : '',
                example_en: props.vocabItem.word_en ? props.vocabItem.example_en : '',
                note: props.vocabItem.note ? props.vocabItem.note : '',
                isShowing: props.vocabItem.isShowing ? props.vocabItem.isShowing : '',
                createdAt: props.vocabItem ? new Date(): new Date()
            }
    }
    handleSubmit = (e) => {
        e.preventDefault();
