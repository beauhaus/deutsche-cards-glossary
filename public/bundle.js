...
var _DisplayCtrl = __webpack_require__(17);
...
var getPartialLS = function getPartialLS(lower, upper) {
    var retrievedDB = localStorage.getItem("dictionaryDB");
    var parsedResult = JSON.parse(retrievedDB);
...
var hello = function hello(title, name) {
    console.log("Hello " + title + ". " + name + ". How are you?");
};

var food = function food(meal, dishName) {
